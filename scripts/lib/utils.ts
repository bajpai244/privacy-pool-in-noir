...
export const u256FromU32ArrayBE = (array: Array<bigint>) => {
  // Accept BigInts
  if (array.length !== 8) {
...
export const bigIntArrayToUint32Array = (array: Array<bigint>) => {
    return new Uint32Array(array.map((v) => {
...
export const calculateCommitment = (
  ...
  const input2 = bigIntArrayToUint32Array(hashBigIntArray.concat(nullifierArray));
